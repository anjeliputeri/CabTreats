...
class BeverageStore extends StatefulWidget {
  final String email;
  final String name;

  const BeverageStore({Key? key, required this.email, required this.name}) : super(key: key);

  @override
  State<BeverageStore> createState() => _BeverageStoreState();
}

class _BeverageStoreState extends State<BeverageStore> {
