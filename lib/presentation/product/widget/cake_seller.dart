...
class CakeSeller extends StatefulWidget {
  final String searchQuery;
  final String addedBy;

  CakeSeller({required this.searchQuery, required this.addedBy});

  @override
  State<CakeSeller> createState() => _CakeSellerState();
}

class _CakeSellerState extends State<CakeSeller> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: db.collection('Cake & Bakery')
