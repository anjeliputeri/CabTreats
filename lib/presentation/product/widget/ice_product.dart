...
class IceProduct extends StatefulWidget {
  final String searchQuery;

  IceProduct({required this.searchQuery});

  @override
  State<IceProduct> createState() => _IceProductState();
}

class _IceProductState extends State<IceProduct> {
