...
class BeverageSeller extends StatefulWidget {
  final String searchQuery;
  final String addedBy;

  BeverageSeller({required this.searchQuery, required this.addedBy});

  @override
  State<BeverageSeller> createState() => _BeverageSellerState();
}

class _BeverageSellerState extends State<BeverageSeller> {
