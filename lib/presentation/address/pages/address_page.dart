                ...
                return BlocBuilder<CheckoutBloc, CheckoutState>(
                  builder: (context, state) {
                    final addressId = state.maybeWhen(
                      orElse: () => 0,
                      loaded: (checkout, addressId, __, ___, ____, _____, ______,________, _______, __________) {
                        return addressId;
                      },
                    );
                ...
                BlocBuilder<CheckoutBloc, CheckoutState>(
                  builder: (context, state) {
                    final subtotal = state.maybeWhen(
                      orElse: () => 0,
                      loaded: (checkout, _, __, ___, ____, _____, _______,________, _________, __________) {
