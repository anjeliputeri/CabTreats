...
class BeverageCategory extends StatefulWidget {
  const BeverageCategory({Key? key}) : super(key: key);

  @override
  State<BeverageCategory> createState() => _BeverageCategoryState();
}

class _BeverageCategoryState extends State<BeverageCategory> {
