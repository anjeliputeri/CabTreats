...
class BeverageExplore extends StatefulWidget {
  final String searchQuery;

  BeverageExplore({required this.searchQuery});

  @override
  State<BeverageExplore> createState() => _BeverageExploreState();
}

class _BeverageExploreState extends State<BeverageExplore> {
