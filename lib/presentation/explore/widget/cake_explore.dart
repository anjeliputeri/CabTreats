...
class CakeExplore extends StatefulWidget {
  final String searchQuery;

  CakeExplore({required this.searchQuery});

  @override
  State<CakeExplore> createState() => _CakeEploreState();
}

class _CakeEploreState extends State<CakeExplore> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: db.collection('Cake & Bakery').snapshots(), // Adjust query based on user role
