...
class CateringExplore extends StatefulWidget {
  final String searchQuery;

  CateringExplore({required this.searchQuery});

  @override
  State<CateringExplore> createState() => _CateringExploreState();
}

class _CateringExploreState extends State<CateringExplore> {
